...
urlpatterns = patterns('',
    ...
    url(r'^aep/pending_scans', views.pending_scans, name="aep/pending_scans"),
    ...
    url(r'^aep/my_projects', views.my_projects, name="aep/my_projects"),
    url(r'^aep/get_project_sprints', views.get_project_sprints, name="aep/get_project_sprints"),
    url(r'^aep/get_cards', views.get_cards, name="aep/get_cards"),
    url(r'^aep/acharts', views.admin_charts, name="aep/admin_charts"),
    url(r'^aep/ucharts', views.user_charts, name="aep/user_charts"),
