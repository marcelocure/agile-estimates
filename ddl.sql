...
CREATE TABLE aep_project(id serial primary key, name varchar(60), id_customer integer, trello_board varchar(500));
...
CREATE TABLE aep_sprint(id serial primary key, description varchar(500), id_project integer, start_date date, end_date date, points_estimated integer, points_delivered integer, number_of_tests integer, date_scanned date, id_user integer);
